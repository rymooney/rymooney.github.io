...
Today, I will be practicing my text analysis using str\_\*() commands, regular expressions, and plotting character-based data! To do this, I will be analyzing character data from all of The New York Times' headlines!
...
First, I am interested in the most common word that appears in The New York Times' headlines.
```{r}
