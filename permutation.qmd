...
Today, I will be running a permutation test using a data set from William Wolberg, Olvi Mangasarian. Nick Street, and W. Street in their paper ["Nuclear feature extraction for breast tumor diagnosis" 1993 Published in Biomedical Image Processing and Biomedical Visualization.](https://minds.wisconsin.edu/bitstream/handle/1793/59692/TR1131.pdf;jsessionid=D67421CDB9C9D60F48E00CFD511DD259?sequence=1). The dataset was downloaded from [UC Irvine Machine Learning Repository](https://archive.ics.uci.edu/dataset/17/breast%2Bcancer%2Bwisconsin%2Bdiagnostic?utm_source=chatgpt.com). The goal is to look at whether there is a correlation between diagnosis of a tumor and tumor size.
